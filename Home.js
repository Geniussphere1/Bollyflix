...
$('#search-icon1').click(function() {
    ...
    // Redirect to /Home page/index.html with search term as query parameter
    window.location.href = '/Home page/index.html?search=' + encodeURIComponent(searchTerm);
});
...
function navigateToCategory(category) {
  window.location.href = `/Home page/index.html?category=${category}`;
}
